...
document.querySelector('#user_info_location').addEventListener('blur',subLocationCheck);
function subLocationCheck() {
  const subLocation = document.querySelector('#user_info_location');
  const errorLocation = document.querySelector('#error_location');
  if(subLocation.value === "") {
    errorLocation.innerText = "상세주소를 입력해주세요!"
  } else {
...
document.querySelector('#carecenter_info_sub').addEventListener('blur',careLocationCheck);
function careLocationCheck() {
  const subLocation = document.querySelector('#carecenter_info_sub');
  const errorLocation = document.querySelector('#error_sub_location');
  if(subLocation.value === "") {
    errorLocation.style.color = "#ff4545";
    errorLocation.innerText = "상세주소를 입력해주세요!";
  } else {
    errorLocation.innerText = "";
  }
...
function userData() {
  const userName = document.querySelector('#user_info_name').value;
  const userId = document.querySelector('#user_info_id').value;
  const userPassword = document.querySelector('#user_info_confirm_pw').value;
  const userBirth = document.querySelector('#user_info_birth_date').value;
